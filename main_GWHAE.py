...
def load_raw_data(data_file):
    ...
    # The first dataframe row is a secondary L*/a*/b* header, not a sample.
    ...
    # Correct LAB selection: skip sample ID, vessel type and decoration colour.
    # The six columns are blue L*/a*/b* and black-spot L*/a*/b*.
...
def expmap_radius_diagnostics(features, curvature):
    ...
    # PoincareBall.proj uses 1-eps=0.996 for float32.
...
def main():
    ...
    # These are exactly the fixed physical split and training-only fitted
    # preprocessors used by GWHAE_git.py's standardized branch.
    ...
    # The imported evaluator calls the unchanged HNN_gram.decision_function,
    # including k=-c and the manuscript Equation (10) projection.
